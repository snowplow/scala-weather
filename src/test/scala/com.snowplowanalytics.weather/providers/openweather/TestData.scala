...
object TestData {
  ...
  val weatherDescriptions = Vector(
    "thunderstorm with light rain", "light intensity drizzle rain", "Sky is Clear",
    "broken clouds", "drizzle", "few clouds", "fog", "haze", "heavy intensity rain",
    "light intensity drizzle", "light rain", "light shower snow", "light snow",
    "mist", "moderate rain", "overcast clouds", "proximity shower rain",
    "proximity thunderstorm", "rain and drizzle", "scattered clouds", "sky is clear",
    "thunderstorm with rain", "thunderstorm", "very heavy rain",
    "light intensity shower rain"
  )

  val icons = Vector("01d", "01n", "02d", "02n", "03d", "03n", "04d", "04n", "09d", "09n", "10d", "10n", "11d",
    "11n", "13d", "13n", "50d", "50n")

  val descriptionIds = Vector(200, 211, 300, 301, 302, 310, 500, 501, 502, 520, 521, 600, 620, 701, 721, 741, 800,
    801, 802, 803, 804)
}
